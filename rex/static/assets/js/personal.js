(function($) {
    ...
    jQuery.fn.show_tree = function(node) {
        ...
        html += !node.empty ?
            ...
            '<div class=\'' + node_class + '\'><a data-toggle="tooltip" data-placement="bottom" style="display:block" onclick=\'click_node_add("' + node.p_binary + '", "' + positon[1] + '")\' value=\'' + node.p_binary + '\' ><i class="fa fa-plus-square type-add"></i></a><span class="name_node">Add User</span>';
